...
export const ZODIAC_COMPANIONS: Record<ZodiacSign, ZodiacCompanion> = {
  aries: {
    ...
    symbol: "♈",
    dateRange: "3.21 - 4.19",
    imagePath: "/assets/zodiac/cards/aries_card.png",
    accentColor: "#F97373",
  ...
  taurus: {
    ...
    symbol: "♉",
    dateRange: "4.20 - 5.20",
    imagePath: "/assets/zodiac/cards/taurus_card.png",
    accentColor: "#8FA86B",
  ...
  gemini: {
    ...
    symbol: "♊",
    dateRange: "5.21 - 6.21",
    imagePath: "/assets/zodiac/cards/gemini_card.png",
    accentColor: "#F5C84B",
  ...
  cancer: {
    ...
    symbol: "♋",
    dateRange: "6.22 - 7.22",
    imagePath: "/assets/zodiac/cards/cancer_card.png",
    accentColor: "#8ABBE8",
  ...
  leo: {
    ...
    symbol: "♌",
    dateRange: "7.23 - 8.22",
    imagePath: "/assets/zodiac/cards/leo_card.png",
    accentColor: "#F6A73A",
  ...
  virgo: {
    ...
    symbol: "♍",
    dateRange: "8.23 - 9.22",
    imagePath: "/assets/zodiac/cards/virgo_card.png",
    accentColor: "#9BAE7A",
  ...
  libra: {
    ...
    imagePath: "/assets/zodiac/cards/libra_card.png",
    accentColor: "#C8A2E8",
  ...
  scorpio: {
    ...
    imagePath: "/assets/zodiac/cards/scorpio_card.png",
    accentColor: "#7C5C9E",
  ...
  sagittarius: {
    ...
    imagePath: "/assets/zodiac/cards/sagittarius_card.png",
    accentColor: "#63A7F2",
  ...
  capricorn: {
    ...
    imagePath: "/assets/zodiac/cards/capricorn_card.png",
    accentColor: "#7F8794",
  ...
  aquarius: {
    ...
    symbol: "♒",
    dateRange: "1.20 - 2.18",
    imagePath: "/assets/zodiac/cards/aquarius_card.png",
    accentColor: "#36B6D8",
  ...
  pisces: {
    ...
    symbol: "♓",
    dateRange: "2.19 - 3.20",
    imagePath: "/assets/zodiac/cards/pisces_card.png",
    accentColor: "#8BA7F7",
...
export { getZodiacCardPath, getZodiacIconPath } from "./zodiacAssets";
